...
import github.pityamskoy.musicbot.events.QuantityListener;
import github.pityamskoy.musicbot.events.StatusListener;
...
public final class MusicBot {
    public MusicBot() throws LoginException {
        ...
        shardManager.addEventListener(new CommandManager(),
                new QuantityListener(), new StatusListener());
    }
}